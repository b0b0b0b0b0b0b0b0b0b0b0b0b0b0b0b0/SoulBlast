...
- **сохранение** в `ps/regions/<мир>_<x>_<y>_<z>.yml` — после рестарта голограммы на месте;
- **файлы типов** `ps/types/` — alias из PS подтягиваются автоматически, дальше крутишь голограмму и прочность под сервер.
...
Право меню: `menu.yml` → `command.permission`.
